    ...
    if (inputTriangles != String.null) { 
        ...
        for (var whichSet=0; whichSet<inputTriangles.length; whichSet++) {
            ...
            for (whichSetVert=0; whichSetVert<inputTriangles[whichSet].vertices.length; whichSetVert++) {
				...
				colArray.push(inputTriangles[whichSet].material.diffuse[0], inputTriangles[whichSet].material.diffuse[1], inputTriangles[whichSet].material.diffuse[2]);
...
function renderTriangles() {
	...
	// color buffer: activate and feed into color shader
	gl.bindBuffer(gl.ARRAY_BUFFER,colBuffer); // activate
    gl.vertexAttribPointer(colPositionAttrib, 3,gl.FLOAT,false,0,0);
